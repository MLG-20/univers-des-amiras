<x-shop-layout :title="'Mes commandes — '.config('app.name')">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="rounded-2xl border border-brand-ink/10 bg-white p-10 sm:p-14 text-center">
            ...
            <a href="{{ route('shop.index') }}" class="group mt-6 inline-flex items-center gap-2 rounded-full bg-brand-ink px-6 py-3 text-sm uppercase tracking-wide text-brand-surface transition-all duration-300 hover:bg-brand-accent hover:text-brand-surface">
